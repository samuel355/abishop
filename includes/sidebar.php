            ...
            <ul>
                <li class="submenu-open">
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="addsale"><i data-feather="smartphone"></i><span>Add Sale</span></a>
                ...
                <li class="submenu-open">
                    ...
                    <ul>
                        <li><a href="productlist"><i data-feather="box"></i><span>Products</span></a></li>
                        <li><a href="addproduct"><i data-feather="plus-square"></i><span>Create Product</span></a></li>
                        <li><a href="categorylist"><i data-feather="codepen"></i><span>Category</span></a></li>
                ...
                <li class="submenu-open">
                    ...
                    <ul>
                        ...
                        <li>
                            <a dataEmail='<?php echo $_SESSION['email'] ?>' class="logoutButton text-danger"><i data-feather="log-out"></i><span>Logout</span> </a>
                        </li>
                    </ul>
                </li>
            </ul>
