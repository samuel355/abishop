...
if (isset($_GET['productId'])) {
    ...
    $query = mysqli_query($con, "SELECT a.productId, a.productName, a.price, b.id, b.productId, b.quantity, b.subtotal, b.userId FROM products a, cart b WHERE a.productId = b.productId AND b.userId = '{$_SESSION['uid']}' ");
